...
#Mohsen username: m-nejatiyan password: Nem@4321
#Khalil username: l-khalil password: La914826
...
echo "GW=${ORIG_GW} Link=${ORIG_LK} VPN=$HOST"
...
route add 5.160.55.17 gw ${ORIG_GW} dev ${ORIG_LK}
echo "route 1/3: ok"
sleep 1
